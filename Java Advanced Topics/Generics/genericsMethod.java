...
class genericMethod {
    ...
    // To make the method type safety we need to convert the method to a GENERIC Method By replacing the line as follows:

    //	Before: public static List arrayToList(Object[] data, List<Object> result)

    //  After: 	public static <T> List arrayToList(T[] data, List<T> result)

    // In this way by using the generic method we can avoid type mismatching error within to compile of execution.
